---
title: "Policy Change Endorsement Workflows"
sidebarTitle: "Overview"
description: "Turn natural-language change requests into structured, reviewable carrier work with the CL SDK Policy Change Endorsement agent and submission tooling."
---
...
<ParamField path="generateObject" type="GenerateObjectFn" required>
  Structured object generation function for parsing change items and running validation schemas.
</ParamField>

<ParamField path="sourceRetriever" type="SourceRetriever" required>
  Retriever used to pull policy and conversation evidence. Use `MemorySourceStore` for testing or provide a production implementation backed by your document store.
</ParamField>
...
<CardGroup cols={2}>
  <Card title="Workflow Phases" href="/cl-sdk/pce/workflow" icon="diagram-project">
    Explore each phase of the PCE state machine, execution modes, and standalone helper functions.
  </Card>
  <Card title="Submission Packets" href="/cl-sdk/pce/submission-packet" icon="paper-plane">
