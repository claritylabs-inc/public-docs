---
title: "CL SDK: Provider-agnostic LLM insurance toolkit"
...
CL SDK (`@claritylabs/cl-sdk`) v4.5.0 gives you a complete toolkit for building LLM-powered insurance workflows entirely in TypeScript. Because it communicates with language models through plain callback functions—`GenerateText` and `GenerateObject`—you choose your own AI provider and model without any framework lock-in.
