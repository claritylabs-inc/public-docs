---
title: "CL SDK API Reference: Core Functions"
...
<ParamField body="sourceSpans" type="SourceSpan[]">
  Pre-built source spans to use instead of extracting them from the PDF. When provided, the extractor skips its internal span builder.
</ParamField>
...
const agent = createQueryAgent({
  ...
  maxVerifyRounds,        // optional — re-verification iterations (default: 2)
  retrievalLimit,         // optional — spans per retrieval call (default: 5)
