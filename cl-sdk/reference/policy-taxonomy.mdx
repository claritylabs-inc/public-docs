---
title: "ACORD Line of Business Codes and Policy Taxonomy"
...
<ResponseField name="LEGACY_POLICY_TYPE_TO_LOB" type="Record<string, AcordLobCode>">
  Maps legacy `policyType` string values (e.g. `"general_liability"`, `"commercial_auto"`) to canonical ACORD codes. Used internally by the extractor's migration layer.
</ResponseField>
