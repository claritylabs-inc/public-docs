---
title: "Policy Classification with ACORD LOB Codes"
...
<Tabs>
  ...
  <Tab title="resolveOperationalProfileLinesOfBusiness">
    Reads the `linesOfBusiness` field from a `PolicyOperationalProfile` and returns the resolved, normalized code array. Use this when you receive a profile object and want a clean code list without manual normalization.
...
const codes = resolveOperationalProfileLinesOfBusiness(result.operationalProfile!);
