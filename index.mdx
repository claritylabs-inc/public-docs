...
<CardGroup cols={3}>
  ...
  <Card title="CL Sync" icon="rotate" href="/cl-sync/index">
    Local-first browser sync with IndexedDB, optimistic mutations, React hooks, and a Convex adapter.
  </Card>
  <Card title="CL Pipelines" icon="diagram-next" href="/cl-pipelines/index">
...
<CardGroup cols={2}>
  ...
  <Card title="GitHub" icon="github" href="https://github.com/claritylabs-inc">
